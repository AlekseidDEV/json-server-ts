...
/***/ "./src/modules/errorRequest.ts":
/*!*************************************!*\
  !*** ./src/modules/errorRequest.ts ***!
  \*************************************/
/***/ ((__unused_webpack_module, exports) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.errorRequest = void 0;\nconst errorRequest = (error) => {\n    const errorMes = document.querySelector('.error_Mes');\n    if (error) {\n        errorMes.style.display = 'block';\n    }\n    else {\n        errorMes.style.display = 'none';\n    }\n};\nexports.errorRequest = errorRequest;\n\n\n//# sourceURL=webpack://json-sever__lesson/./src/modules/errorRequest.ts?");
